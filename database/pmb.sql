...
--
-- Host: 127.0.0.1
-- Generation Time: 10 Jan 2017 pada 16.44
-- Versi Server: 5.6.24
-- PHP Version: 5.5.24
...
CREATE TABLE IF NOT EXISTS `tagihan` (
  `NO` varchar(20) NOT NULL,
  `ID_DESA` varchar(20) NOT NULL,
  `ID_TGH` varchar(20) NOT NULL,
  `OP_REALISASI` varchar(20) NOT NULL,
  `JML_REALISASI` varchar(20) NOT NULL,
  `OP_SELISIH` varchar(20) NOT NULL,
  `JML_SELISIH` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tagihan` (`NO`, `ID_DESA`, `ID_TGH`, `OP_REALISASI`, `JML_REALISASI`, `OP_SELISIH`, `JML_SELISIH`) VALUES
('1', 'DS01', 'TGH1', '1.420', '12.850.379', '3.238', '515.272'),
('2', 'DS02', 'TGH2', '1.602', '13.757.648', '0', '0');
