            ...
            <nav class="indigo darken-4">
              <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                  <li class="active"><a href="#!">Tagihan Kabupaten</a></li>
                  <li><a href="tambahtagihankabupaten.php" class="waves-effect waves-light btn indigo darken-3 lighten-1" >Tambah Data</a></li>
                ...
                <?php
          		$query = mysql_query("SELECT  id_tagihan, kecamatan, op_baku, op_jumlah, op_realisasi, jml_realisasi, op_selisih, jml_selisih FROM tagihan 
					...
					<tr>
						...
						<td style="text-align:center;"><a href="ubahtagihankabupaten.php?id_cln=<?php echo $data['id_tagihan'];?>">Ubah</a>
							<a href="hapustagihankabupaten.php?id_tagihan=<?php echo $data['id_tagihan'];?>" class="red-text" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>
          			</tr>
          			<?php }
