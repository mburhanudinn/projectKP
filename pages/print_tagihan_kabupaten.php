...
$pdf->ln(1);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(19.5,0.7,"Laporan Tagihan Pajak Bumi dan Bangunan",0,10,'C');
...
$pdf->Cell(2.5, 0.8, 'Kecamatan', 1, 0, 'C');
...
while($lihat=mysql_fetch_array($query)){
	...
	$pdf->Cell(2.5, 0.8, $lihat['kecamatan'], 1, 0,'C');
...
$pdf->Output("Tagihan Kabupaten.pdf","I");
