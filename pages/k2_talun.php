					...
					<div class="col 6 s12">
						<div class="card-panel indigo darken-4 darken-2 center-align">
						  ...
						  <ul id='dropdown4' class='dropdown-content'>
							<li><a href="../laporan_mingguan/lm_desa_mesoyi.php">Desa Mesoyi</a></li>
							<li><a href="../laporan_mingguan/lm_desa_jolotigo.php">Desa Jolotigo</a></li>
							<li><a href="../laporan_mingguan/lm_desa_sengare.php">Desa Sengare</a></li>
							<li><a href="../laporan_mingguan/lm_desa_donowangun.php">Desa Donowangun</a></li>
							<li><a href="../laporan_mingguan/lm_desa_talun.php">Desa Talun</a></li>
							<li><a href="../laporan_mingguan/lm_desa_banjarsari.php">Desa Banjarsari</a></li>
							<li><a href="../laporan_mingguan/lm_desa_kalirejo.php">Desa Kalirejo</a></li>
							<li><a href="../laporan_mingguan/lm_desa_batursari.php">Desa Batursari</a></li>
							<li><a href="../laporan_mingguan/lm_desa_karangasem.php">Desa Karangasem</a></li>
							<li><a href="../laporan_mingguan/lm_desa_krompeng.php">Desa Krompeng</a></li>
						  </ul>
						<br><br>
