  ...
  <body>
    <div class="navbar-fixed">
        <nav class="indigo darken-4">
          <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
              <li class="active"><a href="#!">Cetak Tagihan Kecamatan</a></li>
      ...
      <div class="container col s6 offset-s3 card-panel z-depth-3">
              <form action="inputnomorsuratkecamatan.php" method="post" style="margin-top:5%;">
              <div class="input-field col s9 m12">
                <center><span>Masukan ID Tagihan Kecamatan</span><br></center>
                ...
                <button class="btn waves-effect red darken-2">Cetak Tagihan Berdasarkan ID</button>
                <!-- <button class="btn waves-effect red darken-2" type="button" Value="Kembali" Onclick="window.location.href='print_tgh_kecamatan.php'">Cetak Tagihan Berdasarkan ID</button> -->
                <br><br>
                <br><br>
              </div>
              </form>
