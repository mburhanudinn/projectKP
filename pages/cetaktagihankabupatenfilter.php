            ...
            <nav class="indigo darken-4">
              <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                  ...
                  <li><a href="print_tagihan_kabupatenfilter.php?id=<?php echo $tanggal1 ?>&id2=<?php echo $tanggal2 ?>"
                  class="waves-effect waves-light btn indigo darken-3 lighten-1" >Cetak Tagihan Filter</a></li>
              ...
              <tbody>
                ...
                for($id=$tanggal1;$id<=$tanggal2;$id++){
                  $query = mysql_query("SELECT  id_tagihan, kecamatan, op_baku, op_jumlah, op_realisasi, jml_realisasi, op_selisih, jml_selisih FROM tagihan 
					  ...
					  INNER JOIN laporan USING (id_desa) WHERE id_tagihan LIKE 'TG_$id';");
