            ...
            <nav class="indigo darken-4">
              <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                  <li class="active"><a href="cetaksemuatagihankecamatan.php">Tagihan Kecamatan</a></li>
                  <li><a href="print_tagihan_kecamatan.php" class="waves-effect waves-light btn indigo darken-3 lighten-1" >Cetak Tagihan</a></li>
