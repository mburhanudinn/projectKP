        ...
        <div class="navbar-fixed">
            <nav class="indigo darken-4">
              <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                  <li class="active"><a href="tagihandesa.php">Tagihan Desa</a></li>
                  <li><a href="print_tagihan_desafilter.php?id=<?php echo $tanggal1 ?>&id2=<?php echo $tanggal2 ?>" class="waves-effect waves-light btn indigo darken-3 lighten-1" >Cetak Tagihan Filter</a></li>
         ...
         <div class="container">
            <table  class="striped z-depth-3 display indigo darken-4" id="calonmhs" cellspacing="0" width="100%">
                 ...
                 <?php
				 $no = 1;
				 for($id=$tanggal1;$id<=$tanggal2;$id++){
          			$query = mysql_query("SELECT  id_tagihan, des, op_realisasi, jml_realisasi, op_selisih, jml_selisih FROM tagihan INNER JOIN desa USING (id_desa) WHERE id_tagihan LIKE 'TG_$id';");
