            ...
            <nav class="indigo darken-4">
              <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                  <li class="active"><a href="#!">Tagihan Kecamatan</a></li>
                  <li><a href="tambahtagihankecamatan.php" class="waves-effect waves-light btn indigo darken-3 lighten-1" >Tambah Data</a></li>
            ...
            <table  class="striped z-depth-3 display indigo darken-4" id="calonmhs" cellspacing="0" width="100%">
                ...
                <?php
					...
					<tr>
						...
						<td style="text-align:center;"><a href="ubahtagihankecamatan.php?id_cln=<?php echo $data['id_tagihan'];?>">Ubah</a>
							<a href="hapustagihankecamatan.php?id_tagihan=<?php echo $data['id_tagihan'];?>" class="red-text" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>
          			</tr>
          			<?php }
