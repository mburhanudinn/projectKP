      ...
      <nav class="indigo darken-4">
        <div class="nav-wrapper container">
          ...
          <ul class="right hide-on-med-and-down">
            <li><a href="tambahtagihandesa.php">Form Tambah Data Desa</a></li>
    ...
    <div class="row">
      <div class="section" id="index-banner">
        <div class="container col s6 offset-s3 card-panel z-depth-3">
          <h5><center>Tambah Tagihan Desa</center></h5>
          ...
          <form style="display: none;" action="inserttagihandesa.php" method="post" style="margin-top:5%;" id="form-lanjutan">
