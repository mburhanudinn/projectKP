      ...
      <body>
        <div class="navbar-fixed">
            <nav class="indigo darken-4">
              <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                  <li class="active"><a href="#!">Tagihan Desa</a></li>
                  <li><a href="tambahtagihandesa.php" class="waves-effect waves-light btn indigo darken-3 lighten-1" >Tambah Data</a></li>
         ...
         <div class="container">
          ...
          <a href="ubahtagihandesa.php?id_tagihan=<?php echo $data['id_tagihan'];?>">Ubah</a>

					<a href="hapustagihandesa.php?id_tagihan=<?php echo $data['id_tagihan'];?>" class="red-text" onclick="javascript: return confirm('Anda yakin hapus ?')">Hapus</a></td>
          			</tr>
          			<?php }
