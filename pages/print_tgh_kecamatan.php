...
require('../pdf/fpdf.php');
	...
	//echo $id_desa;
	$query2 = mysql_query("SELECT op_jumlah from laporan where id_kecamatan IN ('$id_kecamatan')");
...
$pdf->ln(0.7);
$pdf->SetFont('Arial','',10);
$pdf->Cell(14,0,"Kepada : ",0,0,'R');
$pdf->ln(0.7);
$pdf->SetFont('Arial','',10);
$pdf->Cell(4,0,"Nomor       : 2017/X/PKL/DPPKD/00".$nomorsurat,0,0,'L');
$pdf->ln(0);
$pdf->SetFont('Arial','',10);
$pdf->Cell(16.3,0,"Yth. Ka. Kel./Desa ".$namakecamatan,0,0,'R');
$pdf->ln(0.7);
$pdf->SetFont('Arial','',10);
$pdf->Cell(4,0,"Lampiran  : -",0,0,'L');
$pdf->ln(0);
$pdf->SetFont('Arial','',10);
$pdf->Cell(15,0,"Di Pekalongan ",0,0,'R');
$pdf->ln(0.7);
$pdf->SetFont('Arial','',10);
...
$pdf->Image('ttd.png',11.2,21	,5,2.5);
$pdf->ln(2.5);
...
$pdf->Output("Surat Tagihan Kecamatan.pdf","I");
