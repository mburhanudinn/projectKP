    ...
    <div class="navbar-fixed">
        <nav class="indigo darken-4">
          <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
              <li class="active"><a href="cetak_tagihan_desa.php">Cetak Tagihan Desa</a></li>
      ...
      <div class="container col s6 offset-s3 card-panel z-depth-3">
              ...
              <div class="input-field col s2 m6">
                ...
                <button class="btn waves-effect red darken-2" type="button" Value="Kembali" Onclick="window.location.href='cetaksemuatagihandesa.php'">Lihat Tagihan Keseluruhan</button>
                <br><br>
              </div>
              </form>
        </div>
