...
$query = "
	INSERT INTO tagihan (id_kecamatan, id_desa, id_tagihan, op_realisasi, jml_realisasi, op_selisih, jml_selisih) VALUES ('$id_kec', '$des', '$id_tagihan', '$op_realisasi', '$jml_realisasi', '$op_selisih', '$jml_selisih')
";
$query2 = "
...
if ($query) {
  // jika berhasil menyimpan
	//echo 'berhasil';
 header('location: tagihankecamatan.php?message=berhasil');
} else {
  // jika gagal menyimpan 
  //echo 'gagal';
  //echo mysql_error();
  header('location: tagihankecamatan.php?message=gagal');
}
?>
