      ...
      <body>
        <div class="navbar-fixed">
            <nav class="indigo darken-4">
              <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                  <li><a href="#!">Ubah Tagihan Desa</a></li>
          ...
          <div class="container col s6 offset-s3 card-panel z-depth-3">
                <form action="updatetagihandesa.php" method="post" style="margin-top:5%;">
                <h5><center>Ubah Data Tagihan Desa</center></h5>
                <?php
                  // terima id_cln dari halaman calonmahasiswa.php
                  $id_tagihan = $_GET['id_tagihan'];
                  $query = mysql_query("select tagihan.*, desa.des from tagihan INNER JOIN desa ON tagihan.id_desa=desa.id_desa where id_tagihan='$id_tagihan'");
                  $data = mysql_fetch_array($query);
                  ?>
                <div class="input-field col s12">
                    <i class="material-icons prefix">credit_card</i>
                    <input id="icon_prefix" type="text" class="validate" name="id_tagihan" value="<?php echo $data['id_tagihan']; ?>" disabled>
