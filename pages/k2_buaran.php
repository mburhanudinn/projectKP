					...
					<div class="col 6 s12">
						<div class="card-panel indigo darken-4 darken-2 center-align">
						  ...
						  <ul id='dropdown4' class='dropdown-content'>
							<li><a href="../laporan_mingguan/lm_desa_coprayan.php">Desa Coprayan</a></li>
							<li><a href="../laporan_mingguan/lm_desa_sapugarut.php">Desa Sapugarut</a></li>
							<li><a href="../laporan_mingguan/lm_desa_wonoyoso.php">Desa Wonoyoso</a></li>
							<li><a href="../laporan_mingguan/lm_desa_bligo.php">Desa Bligo</a></li>
							<li><a href="../laporan_mingguan/lm_desa_pakumbulan.php">Desa Pakumbulan</a></li>
							<li><a href="../laporan_mingguan/lm_desa_watusalam.php">Desa Watusalam</a></li>
							<li><a href="../laporan_mingguan/lm_desa_simbangwetan.php">Desa Simbang Wetan</a></li>
							<li><a href="../laporan_mingguan/lm_desa_simbangkulon.php">Desa Simbang Kulon</a></li>
							<li><a href="../laporan_mingguan/lm_desa_kertijayan.php">Desa Kertijayan</a></li>
							<li><a href="../laporan_mingguan/lm_desa_pawedan.php">Desa Pawedan</a></li>
						  </ul>
						<br><br>
