      ...
      <nav class="indigo darken-4">
        <div class="nav-wrapper container">
          ...
          <ul class="right hide-on-med-and-down">
            <li><a href="tambahtagihankabupaten.php">Form Tambah Data Kabupaten</a></li>
    ...
    <div class="row">
      <div class="section" id="index-banner">
        <div class="container col s6 offset-s3 card-panel z-depth-3">
          <form action="inserttagihankecamatan.php" method="post" style="margin-top:5%;">
            <h5><center>Tambah Tagihan Kabupaten</center></h5>
            ...
            <div class="input-field col s1">
             ...
             <select name="des">
               ...
               <?php 
               $column=mysql_query("SELECT * FROM kecamatan");
               while ($data_column=mysql_fetch_array($column)){?>
               <option value="<?php echo $data_column[3]; ?>"><?php echo $data_column[2];?></option>
               <?php }
               ?>
             </select>
