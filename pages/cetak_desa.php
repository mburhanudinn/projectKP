  ...
  <body>
    <div class="navbar-fixed">
        <nav class="indigo darken-4">
          <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
              <li class="active"><a href="#!">Cetak Tagihan Desa</a></li>
      ...
      <div class="container col s6 offset-s3 card-panel z-depth-3">
              <form action="inputnomorsuratdesa.php" method="post" style="margin-top:5%;">
              <div class="input-field col s9 m12">
                <center><span>Masukan ID Tagihan Desa</span><br></center>
                <i class="material-icons prefix"></i>
                  <input type="text" class="validate" id="tanggal1" name="tanggal1" required>
              </div>
