  ...
  <div class="row">
    <div class="section no-pad-bot" id="index-banner" style="margin-top:10%;">
      <div class="container col s6 offset-s3 card-panel z-depth-3">
          ...
          <div class="center">
            <button class="btn waves-effect waves-light indigo darken-4" type="submit" name="login">Masuk<i class="material-icons right"></i></button>
          </div>
        </form>
        <p class="center"> Copyright Sistem Komputer 2017 </p>
      </div>
    </div>
  </div>
